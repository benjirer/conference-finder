...
from .sources import (
    ...
    cached_extras, areas_classify, geocode, cached_pc,
)
...
def main():
    ...
    _run("[12/17] cached PC members",        cached_pc.apply_cached_pc)
    # Live LLM enrichment intentionally not in the pipeline — see commit 0f2e8fe.
